...
- A [Clerk](https://clerk.com) account (free tier works for small deployments)
...
# Required — from https://dashboard.clerk.com
...
- [Configuration](/docs/self-hosting/configuration) — All environment variables and Clerk setup
