...
<Mermaid chart={`flowchart TB
    ...
    subgraph untrusted [Untrusted Zone]
        Server[Onera Server - Encrypted Blob Store]
    end
...
<Cards>
  <Card title="Self-Hosting Guide" href="/docs/self-hosting" description="Deploy Onera on your own infrastructure with Docker Compose" />
