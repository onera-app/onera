...
export function BentoCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 border border-neutral-200/50 dark:border-neutral-700 rounded-3xl pointer-events-none" />
    </div>
  );
}
...
export function BentoGrid({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mx-auto max-w-[980px]",
        className,
      )}
    >
      {children}
