...
export function Footer() {
  return (
    <footer className="border-t border-neutral-200 dark:border-neutral-800 py-12 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-3">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-neutral-900 dark:text-white">Onera</span>
          </Link>
          <p className="text-sm text-neutral-500 dark:text-neutral-400 max-w-xs text-center md:text-left">
            AI chat that keeps your conversations private.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-neutral-100 dark:border-neutral-800">
