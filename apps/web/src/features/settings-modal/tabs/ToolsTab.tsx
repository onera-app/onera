            ...
            {configuredProviders.length > 0 && (
              <div className="space-y-2 pt-2 border-t">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setDefaultSearchProvider(v as SearchProvider)
                  }
                >
            ...
            <Card key={provider.id}>
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Switch
                    checked={
                      nativeSearchSettings[provider.id]?.enabled ?? false
                    }
                    onCheckedChange={(checked) =>
                      setNativeSearchEnabled(provider.id, checked)
                    }
                  />
                </div>
                ...
                {provider.id === "xai" && nativeSearchSettings.xai?.enabled && (
                  <div className="mt-4 pt-3 border-t space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        checked={
                          nativeSearchSettings.xai?.enableImageUnderstanding ??
                          true
                        }
                        onCheckedChange={(checked) =>
                          setNativeSearchSettings("xai", {
                            enableImageUnderstanding: checked,
                          })
                        }
                      />
                    </div>
...
function ProviderCard({
  ...
  return (
    <Card
      className={
        isConfigured ? "border-status-success/30 bg-status-success/5" : ""
      }
    >
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-4">
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to remove the {provider.name} API
                      key? You'll need to add it again to use this search
                      provider.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
